package com.liwncy.framework.cache;
...
public class CacheAspect {
     ...
     * 声明部门的切面表达式
     */
    private static final String POINTCUT_DEPT_ADD="execution(* com.liwncy.system.sysdept.service.impl.SysDeptServiceImpl.save(..))";
    private static final String POINTCUT_DEPT_UPDATE="execution(* com.liwncy.system.sysdept.service.impl.SysDeptServiceImpl.updateById(..))";
    private static final String POINTCUT_DEPT_GET="execution(* com.liwncy.system.sysdept.service.impl.SysDeptServiceImpl.getById(..))";
    private static final String POINTCUT_DEPT_DELETE="execution(* com.liwncy.system.sysdept.service.impl.SysDeptServiceImpl.removeById(..))";
     ...
     * 声明用户的切面表达式
     */
    private static final String POINTCUT_USER_UPDATE="execution(* com.liwncy.system.sysuser.service.impl.SysUserServiceImpl.updateById(..))";
    private static final String POINTCUT_USER_ADD="execution(* com.liwncy.system.sysuser.service.impl.SysUserServiceImpl.updateById(..))";
    private static final String POINTCUT_USER_GET="execution(* com.liwncy.system.sysuser.service.impl.SysUserServiceImpl.getById(..))";
    private static final String POINTCUT_USER_DELETE="execution(* com.liwncy.system.sysuser.service.impl.SysUserServiceImpl.removeById(..))";
