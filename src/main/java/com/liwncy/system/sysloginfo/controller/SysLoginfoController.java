package com.liwncy.system.sysloginfo.controller;
...
import com.liwncy.system.sysloginfo.model.LoginfoVo;
...
public class SysLoginfoController {
    ...
    public DataGridView loadAllLoginfo(LoginfoVo loginfoVo){
        ...
        QueryWrapper<SysLoginfo> queryWrapper = new QueryWrapper<SysLoginfo>();
        //进行模糊查询
