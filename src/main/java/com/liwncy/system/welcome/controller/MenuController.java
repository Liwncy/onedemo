package com.liwncy.system.welcome.controller;
...
import com.liwncy.common.treeNode.controller.TreeNodeBuilder;
import com.liwncy.common.treeNode.model.TreeNode;
...
import com.liwncy.system.syspermisson.model.PermissionVo;
...
public class MenuController {
    ...
    public Map<String,Object> loadMenuMaxOrderNum(){
        ...
        List<SysPermission> list = permissionService.page(page,queryWrapper).getRecords();
        if (list.size()>0){
