package com.liwncy.system.sysdept.controller;
...
import com.liwncy.system.sysdept.model.DeptVo;
...
public class SysDeptController {
    ...
    public Map<String,Object> loadDeptMaxOrderNum(){
        ...
        List<SysDept> list = deptService.page(page,queryWrapper).getRecords();
        if (list.size()>0){
